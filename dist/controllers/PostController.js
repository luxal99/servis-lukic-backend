...
var PostController = /** @class */ (function () {
    ...
    PostController.prototype.routes = function () {
        ...
        this.app.get(const_1.POST_ROUTE + '/' + 'lastThree', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, new PostService_1.PostService().get().subscribe(function (posts) {
                    ...
                    case 2:
                        e_1 = _a.sent();
                        res.status(const_1.HTTP_STATUS_BAD_GATEWAY).send({ e: e_1 });
                        return [3 /*break*/, 3];
